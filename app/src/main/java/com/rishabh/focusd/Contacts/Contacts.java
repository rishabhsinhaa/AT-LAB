...
import com.rishabh.focusd.Gallery.Function;
import com.rishabh.focusd.Messages.NewSmsActivity;
...
public class Contacts extends AppCompatActivity {
    ...
    public class Contact_List_Adapter extends BaseAdapter {
        ...
        public View getView(final int i, View view, ViewGroup viewGroup) {
            view = getLayoutInflater().inflate(R.layout.activity_contacts_list, null);
